...
pub const VERTICAL_TIMING_REGISTER: VolAddress<
	VerticalTimingControl,
	Unsafe,
	Unsafe,
...
pub const ODD_VERTICAL_TIMING_REGISTER: VolAddress<
	BlankingLines,
	Unsafe,
	Unsafe,
> = unsafe { VolAddress::new(0xCC00_200C) };
pub const EVEN_VERTICAL_TIMING_REGISTER: VolAddress<
	BlankingLines,
	Unsafe,
	Unsafe,
...
pub const ODD_BURST_BLANKING_INTERVAL_REGISTER: VolAddress<
	BurstInterval,
	Unsafe,
	Unsafe,
> = unsafe { VolAddress::new(0xCC00_2014) };
pub const EVEN_BURST_BLANKING_INTERVAL_REGISTER: VolAddress<
	BurstInterval,
	Unsafe,
	Unsafe,
...
pub const BOTTOM_FIELD_BASE_REGISTER_L: VolAddress<
	BottomFieldBase,
	Unsafe,
	Unsafe,
...
pub const DISPLAY_LATCH_REGISTER_ZERO: VolAddress<
	DisplayLatchControl,
	Unsafe,
	Unsafe,
> = unsafe { VolAddress::new(0xCC00_2040) };
pub const DISPLAY_LATCH_REGISTER_ONE: VolAddress<
	DisplayLatchControl,
	Unsafe,
	Unsafe,
...
pub const HORIZONTAL_SCALING_REGISTER: VolAddress<
	ScalingControl,
	Unsafe,
	Unsafe,
...
pub const FILTER_COEFFICENT_TABLE_ZERO: VolAddress<
	FilterCoefficents,
	Safe,
	Safe,
> = unsafe { VolAddress::new(0xCC00_204C) };
pub const FILTER_COEFFICENT_TABLE_ONE: VolAddress<
	FilterCoefficents,
	Safe,
	Safe,
> = unsafe { VolAddress::new(0xCC00_2050) };
pub const FILTER_COEFFICENT_TABLE_TWO: VolAddress<
	FilterCoefficents,
	Safe,
	Safe,
> = unsafe { VolAddress::new(0xCC00_2054) };
pub const FILTER_COEFFICENT_TABLE_THREE: VolAddress<
	FilterCoefficents,
	Safe,
	Safe,
> = unsafe { VolAddress::new(0xCC00_2058) };
pub const FILTER_COEFFICENT_TABLE_FOUR: VolAddress<
	FilterCoefficents,
	Safe,
	Safe,
> = unsafe { VolAddress::new(0xCC00_205C) };
pub const FILTER_COEFFICENT_TABLE_FIVE: VolAddress<
	FilterCoefficents,
	Safe,
	Safe,
> = unsafe { VolAddress::new(0xCC00_2060) };
pub const FILTER_COEFFICENT_TABLE_SIX: VolAddress<
	FilterCoefficents,
	Safe,
	Safe,
...
pub const VIDEO_CLOCK_SELECT_REGISTER: VolAddress<
	VideoClockControl,
	Safe,
	Safe,
...
pub const UNUSED_ZERO: VolAddress<u16, Safe, Safe> =
	unsafe { VolAddress::new(0xCC00_2076) };
pub const UNUSED_ONE: VolAddress<u32, Safe, Safe> =
	unsafe { VolAddress::new(0xCC00_2078) };
pub const UNUSED_TWO: VolAddress<u32, Safe, Safe> =
	unsafe { VolAddress::new(0xCC00_207C) };
