...
pub const CPU_FIFO_START: VolAddress<u32, Safe, Safe> =
	unsafe { VolAddress::new(0xCC00_3008) };
pub const CPU_FIFO_END: VolAddress<u32, Unsafe, Unsafe> =
...
pub const RESET: VolAddress<u32, (), Unsafe> =
	unsafe { VolAddress::new(0xCC00_3024) };
