...
pub enum Ioctl {
    ...
    GetViewCount,
    GetViews,
    GetTitleMetadataViewCount,
    GetTitleMetadataViews,
    GetConsumption,
    Deletetitle,
    DeleteTicket,
...
impl From<Ioctl> for i32 {
    fn from(value: Ioctl) -> Self {
        match value {
            ...
            Ioctl::GetDeviceId => todo!(),
            Ioctl::Launch => todo!(),
            Ioctl::OpenActiveTitleContent => todo!(),
            Ioctl::ReadContent => todo!(),
            Ioctl::CloseContent => todo!(),
            Ioctl::GetOwnedTitleCount => todo!(),
            Ioctl::GetOwnedTitles => todo!(),
            Ioctl::GetTitleCount => 14, //0xE
            Ioctl::GetTitles => 15,     //0xF
            Ioctl::GetViewCount => todo!(),
            Ioctl::GetViews => todo!(),
            Ioctl::GetTitleMetadataViewCount => todo!(),
            Ioctl::GetTitleMetadataViews => todo!(),
