...
pub const __fdlibm_posix: __fdlibm_version = 0;
pub type __fdlibm_version = ::libc::c_int;
extern "C" {
...
pub const ARQ_TASK_READY: ::libc::c_uint = 0;
pub const ARQ_TASK_RUNNING: ::libc::c_uint = 1;
pub const ARQ_TASK_FINISHED: ::libc::c_uint = 2;
...
pub const CONF_BIGARRAY: ::libc::c_uint = 1;
pub const CONF_SMALLARRAY: ::libc::c_uint = 2;
pub const CONF_BYTE: ::libc::c_uint = 3;
pub const CONF_SHORT: ::libc::c_uint = 4;
pub const CONF_LONG: ::libc::c_uint = 5;
pub const CONF_BOOL: ::libc::c_uint = 7;
pub type _bindgen_ty_2 = ::libc::c_uint;
pub const CONF_VIDEO_NTSC: ::libc::c_uint = 0;
pub const CONF_VIDEO_PAL: ::libc::c_uint = 1;
pub const CONF_VIDEO_MPAL: ::libc::c_uint = 2;
pub type _bindgen_ty_3 = ::libc::c_uint;
pub const CONF_REGION_JP: ::libc::c_uint = 0;
pub const CONF_REGION_US: ::libc::c_uint = 1;
pub const CONF_REGION_EU: ::libc::c_uint = 2;
pub const CONF_REGION_KR: ::libc::c_uint = 4;
pub const CONF_REGION_CN: ::libc::c_uint = 5;
pub type _bindgen_ty_4 = ::libc::c_uint;
pub const CONF_AREA_JPN: ::libc::c_uint = 0;
pub const CONF_AREA_USA: ::libc::c_uint = 1;
pub const CONF_AREA_EUR: ::libc::c_uint = 2;
pub const CONF_AREA_AUS: ::libc::c_uint = 3;
pub const CONF_AREA_BRA: ::libc::c_uint = 4;
pub const CONF_AREA_TWN: ::libc::c_uint = 5;
pub const CONF_AREA_ROC: ::libc::c_uint = 6;
pub const CONF_AREA_KOR: ::libc::c_uint = 7;
pub const CONF_AREA_HKG: ::libc::c_uint = 8;
pub const CONF_AREA_ASI: ::libc::c_uint = 9;
pub const CONF_AREA_LTN: ::libc::c_uint = 10;
pub const CONF_AREA_SAF: ::libc::c_uint = 11;
pub const CONF_AREA_CHN: ::libc::c_uint = 12;
pub type _bindgen_ty_5 = ::libc::c_uint;
pub const CONF_SHUTDOWN_STANDBY: ::libc::c_uint = 0;
pub const CONF_SHUTDOWN_IDLE: ::libc::c_uint = 1;
pub type _bindgen_ty_6 = ::libc::c_uint;
pub const CONF_LED_OFF: ::libc::c_uint = 0;
pub const CONF_LED_DIM: ::libc::c_uint = 1;
pub const CONF_LED_BRIGHT: ::libc::c_uint = 2;
pub type _bindgen_ty_7 = ::libc::c_uint;
pub const CONF_SOUND_MONO: ::libc::c_uint = 0;
pub const CONF_SOUND_STEREO: ::libc::c_uint = 1;
pub const CONF_SOUND_SURROUND: ::libc::c_uint = 2;
pub type _bindgen_ty_8 = ::libc::c_uint;
pub const CONF_LANG_JAPANESE: ::libc::c_uint = 0;
pub const CONF_LANG_ENGLISH: ::libc::c_uint = 1;
pub const CONF_LANG_GERMAN: ::libc::c_uint = 2;
pub const CONF_LANG_FRENCH: ::libc::c_uint = 3;
pub const CONF_LANG_SPANISH: ::libc::c_uint = 4;
pub const CONF_LANG_ITALIAN: ::libc::c_uint = 5;
pub const CONF_LANG_DUTCH: ::libc::c_uint = 6;
pub const CONF_LANG_SIMP_CHINESE: ::libc::c_uint = 7;
pub const CONF_LANG_TRAD_CHINESE: ::libc::c_uint = 8;
pub const CONF_LANG_KOREAN: ::libc::c_uint = 9;
pub type _bindgen_ty_9 = ::libc::c_uint;
pub const CONF_ASPECT_4_3: ::libc::c_uint = 0;
pub const CONF_ASPECT_16_9: ::libc::c_uint = 1;
pub type _bindgen_ty_10 = ::libc::c_uint;
pub const CONF_SENSORBAR_BOTTOM: ::libc::c_uint = 0;
pub const CONF_SENSORBAR_TOP: ::libc::c_uint = 1;
...
pub const WPAD_CHAN_ALL: ::libc::c_int = -1;
pub const WPAD_CHAN_0: ::libc::c_int = 0;
pub const WPAD_CHAN_1: ::libc::c_int = 1;
pub const WPAD_CHAN_2: ::libc::c_int = 2;
pub const WPAD_CHAN_3: ::libc::c_int = 3;
pub const WPAD_BALANCE_BOARD: ::libc::c_int = 4;
pub const WPAD_MAX_WIIMOTES: ::libc::c_int = 5;
pub type _bindgen_ty_12 = ::libc::c_int;
pub const WPAD_EXP_NONE: ::libc::c_uint = 0;
pub const WPAD_EXP_NUNCHUK: ::libc::c_uint = 1;
pub const WPAD_EXP_CLASSIC: ::libc::c_uint = 2;
pub const WPAD_EXP_GUITARHERO3: ::libc::c_uint = 3;
pub const WPAD_EXP_WIIBOARD: ::libc::c_uint = 4;
pub const WPAD_EXP_UNKNOWN: ::libc::c_uint = 255;
pub type _bindgen_ty_13 = ::libc::c_uint;
pub const WPAD_FMT_BTNS: ::libc::c_uint = 0;
pub const WPAD_FMT_BTNS_ACC: ::libc::c_uint = 1;
pub const WPAD_FMT_BTNS_ACC_IR: ::libc::c_uint = 2;
pub type _bindgen_ty_14 = ::libc::c_uint;
pub const WPAD_STATE_DISABLED: ::libc::c_uint = 0;
pub const WPAD_STATE_ENABLING: ::libc::c_uint = 1;
pub const WPAD_STATE_ENABLED: ::libc::c_uint = 2;
